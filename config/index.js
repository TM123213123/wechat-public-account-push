export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx41875ee3dfbae9bd
",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c2b137dac640ce6fff1fdc4cf47f5227",
   ...
   */
  USERS: ["oZmtg53_SH0AYvNKuVI62BKMm9nU,oZmtg5-sHtZX7M75WcIHmvdq5eUw"]
    {
      // 想要发送的人的名字
      name: "颖宝儿",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oZmtg5-sHtZX7M75WcIHmvdq5eUw",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "k_J-ziWWcQJDlwI4eLhpv8jtMc8yCjrw-hNfZ8joWXg",
      // 所在省份
      province: "甘肃",
      // 所在城市
      city: "酒泉",
      ...
      festivals: [
        ...
        {"type": "* 节日", "name": "结婚纪念日", "year": "2022", "date": "09-02"},
  ...
  CALLBACK_TEMPLATE_ID: "k_J-ziWWcQJDlwI4eLhpv8jtMc8yCjrw-hNfZ8joWXg",

  // 接收成功回调消息的微信号，（一般来说只填自己的微信号, name填不填无所谓）
  CALLBACK_USERS: ["oZmtg53_SH0AYvNKuVI62BKMm9nU"】
    {
      // 一般都填自己
      name: "自己",
